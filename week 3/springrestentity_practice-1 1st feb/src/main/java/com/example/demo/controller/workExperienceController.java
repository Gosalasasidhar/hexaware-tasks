...
import com.example.demo.exception.workNotFound;
...
public class workExperienceController {
	...
	@GetMapping("/get/{id}")
	public workExperience getworkExperienceById(@PathVariable int id)
	{
		return service.getWorkExperience(id);
	}
	...
	public String deleteworkExperienceById(@PathVariable("id") int id) throws workNotFound   
	{
